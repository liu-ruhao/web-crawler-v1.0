...
class Crawler:
        ...
        for image_info in rsp_data['imgs']:
             ...
             try:
                ...
                urllib.request.urlretrieve(image_info['objURL'],'./'+word+'./'+str(self.__counter)+str(suffix))
                 ...
                 print("垃圾+1，已有"+str(self.__counter)+"张灵魂拷问")
                 self.__counter+=1
        return
     #开始获取
    def get_images(self,word='垃圾'):
    ...
    def start(self,word,spider_page_num=1,start_page=1):
        ...
        """
         爬虫入口
         :param word:抓取关键词
         :param spider_page num: 需要抓取数据页数 总抓取图片数量为页数x60
...
if __name__=='__main__':
    crawler=Crawler(0.05) #抓图延时0.05
    crawler.start('湿垃圾',10,1)
